...
extension Color {
    ...
    static let normiSubText = Color(hex: "#6B7280")  // #8E95A5 → #6B7280  // 보조 텍스트
...
extension Font {
    ...
    static let normiCaption  = Font.system(size: 13, weight: .medium, design: .rounded)
    static let normiCaption2 = Font.system(size: 12, weight: .medium, design: .rounded)
}
