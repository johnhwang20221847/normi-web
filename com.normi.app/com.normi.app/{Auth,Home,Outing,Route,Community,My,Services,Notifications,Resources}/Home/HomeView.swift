...
struct HomeView: View {
    ...
    var body: some View {
        NavigationView {
            ZStack(alignment: .top) {
                Color(.systemGroupedBackground).ignoresSafeArea()  // ✅ 수정
                ...
                HStack(spacing: 8) {
                    ...
                    GeometryReader { geo in
                        ZStack(alignment: .leading) {
                            Capsule().fill(Color(.systemGray5)).frame(height: 8)  // ✅ 수정
                            Capsule()
        ...
        HStack(spacing: 14) {
            ZStack {
                Circle()
                    ...
                    .frame(width: 44, height: 44)
                Image(systemName: subwayStatus == .normal
    ...
    private var outingCTA: some View {
        ...
        .background(
            LinearGradient(
                colors: [Color.normiBlue.opacity(0.12), Color.normiBlue.opacity(0.2)],  // ✅ 수정
    ...
    private func recommendCard(_ place: RecommendedPlace) -> some View {
        ...
        .background(Color(.systemBackground))          // ✅ 수정
        .cornerRadius(16)
        .shadow(color: Color(.label).opacity(0.06), radius: 6, y: 2)  // ✅ 수정
    }
}
